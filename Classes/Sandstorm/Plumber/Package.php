...
class Package extends BasePackage {
	 ...
	 * @return void
	 */
	protected function connectToNeosSignals(\TYPO3\Flow\SignalSlot\Dispatcher $dispatcher, \Sandstorm\PhpProfiler\Profiler $profiler, \Sandstorm\PhpProfiler\Domain\Model\ProfilingRun $run, \TYPO3\Flow\Core\Bootstrap $bootstrap) {
